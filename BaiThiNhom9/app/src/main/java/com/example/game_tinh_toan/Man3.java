...
public class Man3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtTinhToan.setText(random1 + " " + toantu +  " X = " + random2);

        btnDongY.setOnClickListener(view -> {
            try {
                switch (toantu) {
                    case "+":
                        values =  (random2 - random1);
                        break;
                    case "-":
                ...
                tongCauDaTraLoi++;
                if (value == values) {
                    Toast.makeText(Man3.this, "Đúng!", Toast.LENGTH_SHORT).show();
                    diem += 10;
                    tongCauTraLoiDung++;
                    Toast.makeText(Man3.this, "+10 điểm", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(Man3.this, "Sai! Kết quả của phép tính là: " + values, Toast.LENGTH_SHORT).show();
                    if (diem != 0) {
                        diem -= 5;
                        Toast.makeText(Man3.this, "-5 điểm", Toast.LENGTH_SHORT).show();
                    } else {
                        diem = 0;
                    }
                }
                ...
                Toast.makeText(Man3.this, "Lỗi", Toast.LENGTH_SHORT).show();
            }
        });
